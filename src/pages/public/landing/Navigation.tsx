    ...
    <>
      ...
      >
        <div className={`max-w-5xl mx-auto px-6 flex items-center justify-between transition-all duration-500 ${
          scrolled 
            ? 'bg-white/80 backdrop-blur-xl border border-slate-200/50 shadow-lg py-2 rounded-full px-8' 
            : 'bg-transparent py-2'
        }`}>
          <div className="flex items-center gap-3 cursor-pointer group" onClick={() => onNavigate('/')}>
            ...
            <span className="font-bold text-lg tracking-tight text-slate-900 flex items-center gap-1.5 transition-colors">
          ...
          <div className="hidden md:flex items-center gap-8">
            {[
              ...
              <button 
                ...
                className="text-[11px] font-bold text-slate-500 uppercase tracking-widest hover:text-slate-900 transition-colors"
              >
                {item.name}
              </button>
            ))}
          ...
          <div className="flex items-center gap-4">
            <button 
              ...
              className="px-5 py-2 bg-slate-900 text-white rounded-full text-xs font-bold hover:bg-slate-800 transition-all active:scale-95"
            >
              Sign In
            </button>
            
            <button 
              className="p-2 text-slate-500 hover:text-slate-900 transition-colors md:hidden"
