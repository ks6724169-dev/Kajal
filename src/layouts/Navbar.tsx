          ...
          {showModulesMenu && (
            <div className="absolute right-0 mt-2 w-80 bg-slate-800 border border-slate-700 rounded-2xl shadow-2xl py-3 z-50">
              <div className="px-4 pb-2 border-b border-slate-700">
                <span className="text-xs font-bold text-white uppercase tracking-wider">Enterprise Modules</span>
              </div>
              <div className="grid grid-cols-3 gap-2 p-3 max-h-96 overflow-y-auto">
                {navItems.map(item => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex flex-col items-center justify-center gap-2 p-3 rounded-xl transition ${
                        activeTab === item.id 
